...
public class AddPerfumeToCartTestCase extends BaseTest {
	...
	public static void DriverInitiation() throws MalformedURLException {
	...
	public void flaconiUserJourney() throws Exception {
		...
		System.out.println("Giorgio Armani Acqua di Giò Homme Eau de Toilette  50 ml" + " perfume to be added to cart is entered in the search container");
		...
		Assert.assertEquals(expectedperfumeInCart, "Giorgio Armani Acqua di Giò Homme Eau de Toilette  50 ml");
